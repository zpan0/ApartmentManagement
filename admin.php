...
<html>
  ...
  <body>
    <header>
      <h1>Admin Page - <?php if(isset($_COOKIE['email'])){echo $_COOKIE['email'];} ?></h1>
      <nav>
        <ul>
    ...
    <main>
  <h1>
    <a class = "createAccount" href="signup.php">Create New Account</a><br>
    <a class = "createAccount" href="lease.php">Create New Lease Agreement</a><br>
    <a class = "createAccount" href="deleteLease.php">Delete a Lease Agreement</a><br>
    <a class = "createAccount" href="billing.php">Bill an Account</a><br>
...
<?php
  ...
  $sql = "SELECT * FROM lease INNER JOIN person ON lease.ResSSN = person.SSN";
...
<?php
  ...
  $sql = "SELECT * FROM billing INNER JOIN payment ON billing.BillingID = payment.BillingID";
  $result = mysqli_query($conn, $sql);
...
<?php
  ...
  $sql = "SELECT * FROM billing WHERE BillingID NOT IN ( SELECT BillingID FROM payment )";
  $result = mysqli_query($conn, $sql);
